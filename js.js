...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    // **INICIO: Llamada a la API para enviar el correo**
    fetch('https://api.emailjs.com/api/v1.0/email/send', {
        method: 'POST',
        body: JSON.stringify({
            service_id: 'api correo', // Reemplaza con tu Service ID de EmailJS
            template_id: 'dijoquesi', // Reemplaza con tu Template ID de EmailJS
            user_id: 'XJWoInaotY9c-IPvG',       // Reemplaza con tu User ID de EmailJS
            template_params: {
                'to_name': 'Javier Arroyo',    // Reemplaza con tu nombre
                'from_name': 'Página San Valentin',
                'message': '¡Alguien ha dicho SÍ a tu invitación de San Valentín!'
            }
        }),
        headers: {
    ...
    .then(response => {
        if (response.ok) {
            ...
            // Opcional: Mostrar un mensaje al usuario de que la notificación ha sido enviada.
        } else {
